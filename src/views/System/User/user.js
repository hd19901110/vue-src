...
export default {
  ...
  methods: {
    ...
    handleSelectKeyChange (data) {
      ...
      this.headers.buttons.find(t => t.type === 'Enable').disabled = !this._checkPermission('/cmsadmin/users/on', 'POST') || isDisabled
      this.headers.buttons.find(t => t.type === 'Disable').disabled = !this._checkPermission('/cmsadmin/users/off', 'POST') || isDisabled
      this.headers.buttons.find(t => t.type === 'Delete').disabled = !this._checkPermission('/cmsadmin/users', 'DELETE') || isDisabled
