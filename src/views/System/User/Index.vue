        ...
        handleColumn: [
          {
            ...
            power: 'deleteAble',
            icon: 'zhongzhimima',
            disabled: !this._checkPermission('/cmsadmin/users/psw', 'POST')
          },
          {
            type: 'Link',
            name: '权限管理',
          ...
          },
          {
            ...
            notDisabled: true,
            power: 'deleteAble',
            disabled: !this._checkPermission('/cmsadmin/users', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: '操作',
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/users', 'POST')
          },
          {
            type: 'Enable',
            text: '启用',
            icon: 'qiyong',
            disabled: !this._checkPermission('/cmsadmin/users/on', 'POST')
          },
          {
            type: 'Disable',
            text: '禁用',
            icon: 'jinyong',
            disabled: !this._checkPermission('/cmsadmin/users/off', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
