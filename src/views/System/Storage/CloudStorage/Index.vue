  ...
  <section class="security-index-container">
    ...
    >
      <template #ossName="scope">
        <el-link :underline="false" :disable="!_checkPermission('/cmsadmin/ftp', 'GET')" class="jee-color" @click="rowHref(scope.scope.row)">{{scope.scope.row.ossName}}</el-link>
      </template>
    </base-table>
    <form-dialog
      ref="addDialog"
        ...
        handleColumn: [
          {
            ...
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/sysOss', 'DELETE')
          }
        ],
        handleColumnProp: {
          width: '75px'
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/sysOss', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
