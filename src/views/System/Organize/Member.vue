        ...
        handleColumn: [
          {
            ...
            name: '移除',
            icon: 'yichu',
            disabled: !this._checkPermission('/cmsadmin/orgs/list/users', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: '操作',
      ...
      return [
        {
          ...
          text: '添加',
          icon: 'tianjia',
          disabled: !this._checkPermission('/cmsadmin/orgs/list/users', 'POST') || !this.managerAble
        },
        {
          type: 'Delete',
          text: '移除',
          icon: 'delete',
          disabled: !this._checkPermission('/cmsadmin/orgs/list/users', 'DELETE') || !this.managerAble
        }
      ]
    }
  },
