...
export default {
      ...
      list: {
        ...
        handleColumn: [
          ...
          },
          {
            ...
            notDisabled: true,
            power: 'deleteAble',
            disabled: !this._checkPermission('/cmsadmin/orgs', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: '操作',
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/orgs', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
  ...
  watch: {
    'list.selectedKeys': function (newData) {
      ...
      this.headers.buttons[1].disabled = !this._checkPermission('/cmsadmin/orgs', 'DELETE')
    },
