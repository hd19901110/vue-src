  ...
  data () {
    const columns = [
      ...
      },
      {
        ...
        scopeType: 'switch',
        type: 'Status',
        disabled: !this._checkPermission('/cmsadmin/model/isEnable', 'PUT')
      }
    ]
    return {
      list: {
        ...
        handleColumn: [
          {
            ...
            name: '模型字段',
            icon: 'ziduanguanli',
            disabled: !this._checkPermission('/cmsadmin/model', 'GET')
          },
          {
            type: 'Delete',
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/model', 'DELETE')
          }
        ],
        draggable: true
      },
            ...
            options: [
              {
                value: '1',
                label: '全站模型',
                disabled: !this._checkPermission('/cmsadmin/model/wholeSite', 'POST')
              },
              {
                value: '0',
                label: '本站模型',
                disabled: !this._checkPermission('/cmsadmin/model/thisSite', 'POST')
              }
            ]
          },
          {
      ...
      editBtns: [
        {
          text: '保存',
          type: 'Submit',
          disabled: !this._checkPermission('/cmsadmin/model', 'PUT')
        }
      ]
    }
  },
