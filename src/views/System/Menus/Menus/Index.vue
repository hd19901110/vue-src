  ...
  data () {
    const columns = [
      ...
      },
      {
        ...
        enableText: '显示',
        disableText: '隐藏',
        disabled: !this._checkPermission('/cmsadmin/menus/display', 'PUT') || !this._checkPermission('/cmsadmin/menus/hidden', 'PUT'),
        minWidth: '100px'
      },
      {
        scopeType: 'switch',
        ...
        enableText: '开启',
        disableText: '关闭',
        disabled: !this._checkPermission('/cmsadmin/menus/closeAuth', 'PUT') || !this._checkPermission('/cmsadmin/menus/openAuth', 'PUT'),
        minWidth: '100px'
      }
    ]
    return {
        ...
        handleColumn: [
          {
            ...
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/menus', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: '操作',
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/menus', 'POST')
          }
        ],
        title: '',
        showAlertIcon: false,
