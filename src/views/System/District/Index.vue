  ...
  <section class="district-content-index">
    ...
    <template #sortNum="scope">
      <el-input type="number" v-model="scope.scope.row.sortNum" maxlength="11" size='mini' min="1" max="99"
        :disabled="!_checkPermission('/cmsadmin/area/sort', 'PUT')"
        ...
        handleColumn: [
          {
            ...
            name: '编辑',
            icon: 'bianji',
            disabled: !this._checkPermission('/cmsadmin/area', 'PUT')
          },
          {
            type: 'Delete',
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/area', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: '操作',
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/area', 'POST')
          }
        ],
        title: '',
        showAlertIcon: false,
