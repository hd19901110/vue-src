          ...
          handleColumn: [
            {
              ...
              name: '重命名',
              icon: 'chongmingming',
              disabled: !this._checkPermission('/cmsadmin/resourceSpaceDatas', 'PUT')
            },
            {
              type: 'Share',
              name: '共享',
              icon: 'gongxiang',
              disabled: !this._checkPermission('/cmsadmin/resourceSpaceDatas/share', 'POST')
            },
            {
              type: 'Move',
              name: '移动',
              icon: 'yidong',
              disabled: !this._checkPermission('/cmsadmin/resourceSpaceDatas/shift', 'PUT')
            },
            {
              type: 'Download',
              name: '下载',
              icon: 'xiazai',
              disabled: !this._checkPermission('/cmsadmin/resourceSpaceDatas/download', 'POST')
            },
            {
              type: 'Delete',
              name: '删除',
              icon: 'tangchuangguanbi',
              disabled: !this._checkPermission('/cmsadmin/resourceSpaceDatas', 'DELETE')
            }
          ],
          handleColumnProp: {
            label: '操作',
  ...
  methods: {
    ...
    showResourceMenus (item, i, e) {
      ...
      if (this.activeName === 'myRes' && item.shareStatus === 2) {
        ...
        this.menuItemList.myRes[2].disabled = !this._checkPermission('/cmsadmin/resourceSpaceDatas/unShare', 'POST')
      } else {
        this.menuItemList.myRes[2].text = '共享'
        this.menuItemList.myRes[2].disabled = !this._checkPermission('/cmsadmin/resourceSpaceDatas/share', 'POST')
      }
    },
    resourceClick (data) {
