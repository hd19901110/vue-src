        ...
        buttons: [
          {
            ...
            text: '新建分类',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/resourceSpaces', 'POST')
          }
        ],
        title: '',
        showAlertIcon: false
      ...
      menuLeftList: [
        {
          key: '1',
          text: '新建',
          disabled: !this._checkPermission('/cmsadmin/resourceSpace', 'POST')
        },
        {
          key: '2',
          text: '重命名',
          disabled: !this._checkPermission('/cmsadmin/resourceSpace', 'PUT')
        },
        {
          key: '3',
          text: '共享',
          disabled: !this._checkPermission('/cmsadmin/resourceSpace/share', 'POST')
        },
        {
          key: '4',
          text: '删除',
          disabled: !this._checkPermission('/cmsadmin/resourceSpace', 'DELETE')
        }
      ]
    }
  },
