        ...
        buttons: [
          {
            ...
            disabled: !this._checkPermission('/cmsadmin/usercomment/status', 'PUT')
          },
          {
            type: 'All',
            btn: 'NoPass',
          ...
          },
          {
            ...
            text: '删除评论',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/usercomment', 'DELETE')
          }
        ]
      }
    },
      ...
      return [
        {
          ...
          hiddenKey: 'isTop',
          hiddenValue: false,
          disabled: !this._checkPermission('/cmsadmin/usercomment/top', 'PUT')
        },
        {
          type: 'NoReferrer',
          icon: 'quxiaotuijian',
        ...
        },
        {
          ...
          hiddenValue: false,
          disabled: !this._checkPermission('/cmsadmin/usercomment/plus/stop', 'PUT')
        },
        {
          type: 'ToUesr',
          icon: 'quxiaojingzhi',
          ...
          hiddenKey: 'isUserDisable',
          hiddenValue: true,
          disabled: !this._checkPermission('/cmsadmin/usercomment/cancel/stop', 'PUT')
        },
        {
          type: 'NoIp',
          icon: 'jinyong',
        ...
        },
        {
          ...
          hiddenKey: 'reply',
          hiddenValue: false,
          disabled: !this._checkPermission('/cmsadmin/usercomment/reply', 'PUT')
        },
        {
          type: 'PutReply',
          icon: 'xiugaihuifu',
