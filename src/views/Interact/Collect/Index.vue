      ...
      <el-aside width="190px">
        <div class="interact-collect-index-tree">
          <div class="interact-collect-index-tree-top">
            <el-button :disabled="!_checkPermission('/interact/collect/detail', 'GET')" type="primary" size="small"
      ...
      headers: {
        buttons: [
          ...
          },
          {
            ...
            icon: 'yidong1',
            isHidden: false,
            disabled: !this._checkPermission('/cmsadmin/collect/consumeByIds', 'POST')
          },
          {
            type: 'DeleteData',
            text: '删除数据',
        ...
        if (item.disabled === false) {
          ...
          if (this.isDisabled) {
            ...
            if (item.type === 'Start') {
              ...
              item.disabled = !this._checkPermission('/cmsadmin/collect/consumeByIds', 'POST')
            }
          }
        } else {
          // 判断是否禁用
