  ...
  <section class="interact-blogroll-detail-container">
    ...
    <template #linkName="scope">
      <el-link :underline='false' type='primary' class='jee-color' @click="rowHref(scope.scope.row)"
        :disabled="!_checkPermission('/cmsadmin/links', 'PUT')"
  ...
  data () {
    const columns = [
      ...
      },
      {
        ...
        enableText: '是',
        disableText: '否',
        disabled: !this._checkPermission('/cmsadmin/links/enable', 'PUT') || !this._checkPermission('/cmsadmin/links/unEnable', 'PUT')
      }
    ]
    return {
      link: '',
        ...
        handleColumn: [
          {
            ...
            name: '移动',
            icon: 'yidong1',
            disabled: !this._checkPermission('/cmsadmin/links/move', 'PUT')
          },
          {
            type: 'Delete',
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/links', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: '操作',
        ...
        buttons: [
          {
            ...
            text: '新建链接',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/links', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
