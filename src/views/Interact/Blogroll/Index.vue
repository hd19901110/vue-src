  ...
  <section class="interact-blogroll-index-container">
    ...
    <template #typeName="scope">
      <el-link :underline='false' type='primary' class='jee-color' @click="rowHref(scope.scope.row)"
        :disabled="!_checkPermission('/cmsadmin/linkTypes', 'PUT')"
        ...
        handleColumn: [
          {
            ...
            disabled: !this._checkPermission('/cmsadmin/links/page', 'GET')
          },
          {
            type: 'Delete',
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/linkTypes', 'DELETE')
          }
        ],
        draggable: true
      },
        ...
        buttons: [
          {
            ...
            text: '新建分类',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/linkTypes', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
