  ...
  <section class="security-index-container">
    ...
    >
      <template #groupName="scope">
        <el-link :underline="false" :disable="!_checkPermission('/cmsadmin/memberGroup', 'GET')" class="jee-color" @click="rowHref(scope.scope.row)">{{scope.scope.row.groupName}}</el-link>
      </template>
    </base-table>
    <form-dialog
      ref="addDialog"
        ...
        handleColumn: [
          {
            ...
            name: '成员管理',
            icon: 'fensiguanli',
            disabled: !this._checkPermission('/cmsadmin/members', 'GET')
          },
          {
            type: 'Delete',
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/memberGroup', 'DELETE')
          }
        ],
        handleColumnProp: {
          width: '170px'
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/memberGroup', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
