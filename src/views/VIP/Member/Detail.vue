    ...
    >
      ...
      <el-form-item class="form-item">
        <el-button  v-show="form.status !== '2'&& form.status !== '0'"
          ...
          size="small"
          @click="handleSubmit"
          :disabled="!_checkPermission('/cmsadmin/members', id ? 'POST' : 'PUT')"
        ...
        buttons: [
          {
            ...
            text: '审核通过',
            icon: 'shenghetongguo',
            disabled: !this._checkPermission('/cmsadmin/members/on', 'POST')
          },
          {
            type: 'AuditNo',
            text: '审核不通过',
            icon: 'shenghebutongguo',
            disabled: !this._checkPermission('/cmsadmin/members/off', 'POST')
          },
          {
            type: 'Deletes',
            text: '删除',
