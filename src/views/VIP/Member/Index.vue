  ...
  data () {
    const columns = [
      ...
      },
      {
        ...
        prop: 'enabled',
        label: '状态',
        disabled: !this._checkPermission('/cmsadmin/members/enable', 'POST') || !this._checkPermission('/cmsadmin/members/disable', 'POST'),
        minWidth: '80px'
      }
    ]
        ...
        handleColumn: [
          {
            ...
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/members', 'DELETE')
          }
        ],
        handleColumnProp: {
          width: '75px'
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/members', 'POST')
          },
          {
            type: 'Start',
            text: '启用',
            icon: 'qiyong',
            disabled: !this._checkPermission('/cmsadmin/members/enable', 'POST')
          },
          {
            type: 'Stop',
            text: '禁用',
            icon: 'jinyong',
            disabled: !this._checkPermission('/cmsadmin/members/disable', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
