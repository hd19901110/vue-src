  ...
  <section class="config-message-index-container">
    ...
    >
      <template #openPhone="scope">
        <el-switch
          :disabled="!_checkPermission('/cmsadmin/messageTpl', 'PUT')"
          class="phoneSuitch"
        ...
        buttons: [
          {
            ...
            text: '同步到子站',
            icon: 'tongbu',
            disabled: !this._checkPermission('/cmsadmin/messageTpl/synch/child/site/tpl', 'POST'),
            isHidden: false,
            params: {
              type: 'add',
    ...
    columns () {
      return [
        ...
        },
        {
          ...
          label: '短信',
          scopeType: 'slot',
          disabled: !this._checkPermission('/cmsadmin/messageTpl', 'PUT')
        },
        {
          prop: 'openMail',
          type: 'Eamil',
