  ...
  data () {
    ...
    const columns = [
      ...
      },
      {
        ...
        scopeType: 'handle',
        type: 'Edit',
        disabled: !this._checkPermission('/cmsadmin/sensitiveWords', 'PUT')
      },
      {
        prop: 'replaceWord',
        label: '替换词'
        ...
        handleColumn: [
          {
            ...
            name: 'global.delete',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/sensitiveWords', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: 'global.handle',
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/sensitiveWords', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
          ...
          },
          {
            ...
            disabled: !this._checkPermission('/cmsadmin/sensitiveWords/import', 'POST')
          }
        ],
        title: '',
        showAlertIcon: false
