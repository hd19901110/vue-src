  ...
  data () {
    ...
    const columns = [
      ...
      },
      {
        ...
        scopeType: 'handle',
        type: 'Edit',
        disabled: !this._checkPermission('/cmsadmin/sysSource', 'PUT')
      },
      {
        prop: 'sourceLink',
        label: '来源链接',
        ...
        handleColumn: [
          {
            ...
            name: 'global.delete',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/sysSource', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: 'global.handle',
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/sysSource', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
