  ...
  data () {
    ...
    const columns = [
      ...
      },
      {
        ...
        scopeType: 'handle',
        type: 'Edit',
        disabled: !this._checkPermission('/cmsadmin/contentTags', 'PUT')
      },
      {
        prop: 'refCounter',
        label: '使用次数'
        ...
        handleColumn: [
          {
            ...
            name: 'global.delete',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/contentTags', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: 'global.handle',
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/contentTags', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
