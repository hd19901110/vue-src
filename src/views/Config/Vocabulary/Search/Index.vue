    ...
    const columns = [
      {
        ...
        scopeType: 'handle',
        type: 'Edit',
        disabled: !this._checkPermission('/cmsadmin/searchWords', 'PUT')
      },
      {
        prop: 'searchCount',
        label: '搜索次数'
        ...
        handleColumn: [
          {
            ...
            name: 'global.delete',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/searchWords', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: 'global.handle',
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/searchWords', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
