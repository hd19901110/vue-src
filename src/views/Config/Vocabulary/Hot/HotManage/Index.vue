    ...
    const columns = [
      {
        ...
        scopeType: 'handle',
        type: 'Edit',
        disabled: !this._checkPermission('/cmsadmin/hotWords', 'PUT')
      },
      {
        prop: 'linkUrl',
        label: '链接',
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/hotWords', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/hotWords', 'DELETE')
          }
        ],
        title: '',
        showAlertIcon: true,
