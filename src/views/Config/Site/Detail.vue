  ...
  <jee-aside-layout class="config-site-detail-container">
    <section slot="asideHeader">
      <el-button
        ...
        :disabled="!_checkPermission('/cmsadmin/sites/recycle', 'GET')"
      >
...
export default {
  ...
  inject: ['removeTab'],
  computed: {
    ...mapGetters(['smsIsGloable', 'smsIsEnable', 'emailIsGloable', 'emailIsEnable', 'siteExtendConfig']),
    openStatic () {
        ...
        buttons: [
          {
            ...
            text: '新建子站点',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/sites', 'POST') || !this.basicForm.form.newChildAble
          },
          {
            type: 'Preview',
            text: '预览',
          ...
          },
          {
            ...
            text: '删除',
            icon: 'delete',
            disabled: this.parentId === null || !this._checkPermission('/cmsadmin/sites', 'DELETE') || !this.basicForm.form.deleteAble
          }
        ],
        showAlertIcon: false
      }
    ...
    basicSubmitBtns () {
      return [{
        text: '保存',
        subType: 'submit',
        disabled: !this._checkPermission('/cmsadmin/sites', 'PUT') || !this.basicForm.form.editAble
      }]
    },
    extSubmitBtns () {
      return [{
        text: '保存',
        subType: 'submit',
        disabled: !this._checkPermission('/cmsadmin/sites/ext', 'PUT') || !this.basicForm.form.editAble
      }]
    },
    templateSubmitBtns () {
      return [{
        text: '保存',
        subType: 'submit',
        disabled: !this._checkPermission('/cmsadmin/sites/model', 'PUT') || !this.basicForm.form.editAble
      }]
    }
  },
  methods: {
