        ...
        handleColumn: [
          {
            ...
            name: 'global.create',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/sites', 'POST')
          },
          {
            type: 'Link',
            name: '预览',
          ...
          },
          {
            ...
            name: 'global.delete',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/sites', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: 'global.handle',
        ...
        buttons: [
          {
            ...
            icon: 'huishouzhan',
            disabled: !this._checkPermission('/cmsadmin/sites/recycle', 'GET')
          }
        ],
        title: '',
        showAlertIcon: false
