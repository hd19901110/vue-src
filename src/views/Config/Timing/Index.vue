  ...
  <section class="security-index-container">
    ...
    <template #cronName="scope">
      <el-link :underline="false" class="cron-name-link jee-color" type="primary"  @click="rowHref(scope.scope.row)"
        :disabled="!_checkPermission('/cmsadmin/jobs', 'PUT')"
  ...
  data () {
    ...
    const columns = [
      ...
      },
      {
        ...
        scopeType: 'switch',
        type: 'Status',
        disabled: !this._checkPermission('/cmsadmin/jobs/enabledJobs', 'POST') || !this._checkPermission('/cmsadmin/jobs/disabledJobs', 'POST')
      }
    ]
    return {
      list: {
        ...
        handleColumn: [
          {
            ...
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/jobs', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: '操作',
        ...
        buttons: [
          {
            ...
            text: '新建',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/jobs', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
