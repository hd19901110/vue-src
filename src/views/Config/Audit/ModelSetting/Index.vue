      ...
      <div class="itemsName">
        ...
        <div class="hide">
          <jee-icon
            ...
            iconClass="bianji"
            :class="{'jee-popover':_checkPermission('/cmsadmin/auditmodelset', 'POST')}"
          />
        </div>
      </div>
    </template>
...
export default {
        ...
        handleColumn: [
          {
            ...
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/auditmodelset', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: '操作',
        ...
        buttons: [
          {
            ...
            text: '添加模型',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/auditmodelset', 'POST')
          },
          {
            type: 'Delete',
            text: '删除模型',
  ...
  methods: {
    ...
    modelNameDialog (item) {
      if (this._checkPermission('/cmsadmin/auditmodelset', 'POST')) {
