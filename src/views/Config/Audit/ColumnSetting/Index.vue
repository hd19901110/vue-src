  ...
  data () {
    const columns = [
      ...
      },
      {
        ...
        disableText: '否',
        type: 'ForcedBy',
        disabled: !this._checkPermission('/cmsadmin/auditchannelset/pass', 'POST')
      },
      {
        prop: 'status',
        label: '状态',
        ...
        disableText: '关闭',
        type: 'Status',
        disabled: !this._checkPermission('/cmsadmin/auditchannelset/on', 'POST')
      }
    ]
    return {
      channelList: [],
        ...
        handleColumn: [
          {
            ...
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/auditchannelset', 'DELETE')
          },
          {
            type: 'AllDelete',
            name: '删除所有栏目',
      ...
      editButtons: [
        {
          text: '保存',
          type: 'Submit',
          disabled: !this._checkPermission('/cmsadmin/auditchannelset', 'POST')
        }
      ],
      editForm: {
        channelId: [],
