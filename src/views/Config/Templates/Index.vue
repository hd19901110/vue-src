...
export default {
        ...
        handleColumn: [
          {
            ...
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/template', 'DELETE')
          }
        ],
        handleColumnProp: {
          width: '75px'
        ...
        buttons: [
          {
            ...
            text: '新建模板',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/template', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
          ...
          },
          {
            ...
            text: '上传',
            icon: 'shangchuan',
            disabled: !this._checkPermission('/cmsadmin/template/upload', 'POST')
          },
          {
            type: 'New',
            text: '新建目录',
            icon: 'weidakaiwenjianjia',
            disabled: !this._checkPermission('/cmsadmin/template/dir', 'POST')
          }
        ],
        title: '',
        showAlertIcon: false
  ...
  methods: {
    ...
    // 导出模板
    handleBtns () {
      window.open(`${this.$path}/cmsadmin/template/export?solution=${this.ExportForm.solution}`)
