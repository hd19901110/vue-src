        ...
        handleColumn: [
          {
            ...
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/resource', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: '操作',
        ...
        buttons: [
          {
            ...
            text: '新建文件',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/resource', 'POST')
          },
          {
            type: 'Delete',
            text: '删除',
          ...
          },
          {
            ...
            text: '上传',
            icon: 'shangchuan',
            disabled: !this._checkPermission('/cmsadmin/resource/upload', 'POST')
          },
          {
            type: 'New',
            text: '新建目录',
            icon: 'weidakaiwenjianjia',
            disabled: !this._checkPermission('/cmsadmin/resource/dir', 'POST')
          }
        ],
        title: '',
        showAlertIcon: false
