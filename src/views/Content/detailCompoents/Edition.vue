          ...
          searchBtns: [
            {
              ...
              type: 'Save',
              name: '保存当前版本',
              disabled: !this._checkPermission('/cmsadmin/contentVersion', 'POST')
            },
            {
              icon: 'ic_restore_page_px',
              type: 'Recovery',
              name: '恢复此版本',
              disabled: !this._checkPermission('/cmsadmin/contentVersion/recovery', 'PUT')
            },
            {
              icon: 'banbenduibi',
              type: 'Contrast',
              name: '与当前版本对比',
              disabled: !this._checkPermission('/cmsadmin/contentVersion/compare', 'POST')
            },
            {
              icon: 'banbenduibi',
              type: 'ContrastSel',
            ...
            },
            {
              ...
              type: 'Delete',
              name: '删除版本',
              disabled: !this._checkPermission('/cmsadmin/contentVersion', 'DELETE')
            }
          ]
        },
        data: [],
