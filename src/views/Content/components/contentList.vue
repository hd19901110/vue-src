    ...
    var footBtns = [
      {
        ...
        power: 'STICK',
        type: 'Istop',
        disabled: !this._checkPermission('/cmsadmin/contentext/top', 'POST')
      },
      {
        icon: 'zhiding',
        name: '取消置顶',
      ...
      },
      {
        ...
        power: 'MOVE',
        type: 'Move',
        disabled: !this._checkPermission('/cmsadmin/contentext/move', 'POST')
      },
      {
        name: '排序',
        type: 'Sort',
        power: 'SORT',
        icon: 'paixu1',
        disabled: !this._checkPermission('/cmsadmin/contentext/sort', 'POST')
      },
      {
        name: '引用',
        type: 'Quote',
        power: 'QUOTE',
        icon: 'yinyong',
        disabled: !this._checkPermission('/cmsadmin/contentext/quote', 'POST')
      },
      {
        icon: 'tangchuangguanbi',
        name: '删除',
        power: 'DELETE',
        type: 'Delete',
        disabled: !this._checkPermission('/cmsadmin/contentext/rubbish', 'POST')
      },
      {
        name: '归档',
        type: 'File',
        power: 'PIGEONHOLE',
        icon: 'guidang',
        disabled: !this._checkPermission('/cmsadmin/contentext/file', 'POST')
      },
      {
        name: '推送到站群',
        type: 'Pushstation',
        power: 'SITE',
        icon: 'tuisongdaozhanqun',
        disabled: !this._checkPermission('/cmsadmin/content/push/sites', 'PUT')
      },
      {
        name: '推送到微信',
        type: 'Pushweixin',
        power: 'WECHAT',
        icon: 'tuisongdaoweixin',
        disabled: !this._checkPermission('/cmsadmin/contentext/push', 'POST')
      },
      {
        name: '推送到微博',
        type: 'Pushweibo',
        power: 'SINA',
        icon: 'tuijiandaoweibo',
        disabled: !this._checkPermission('/cmsadmin/weiboarticlepush', 'POST')
      }
    ]
    return {
      loading: false,
        ...
        drops: [
          {
            ...
            disabled: !this._checkPermission('/cmsadmin/contentext/status', 'POST')
          },
          {
            label: '内容操作',
            key: 'handle',
  ...
  methods: {
    ...
    setHeaderBth (data) {
      ...
      if (data.quote) {
        ...
        this.popverBtns.find(d => d.power === 'QUOTE').disabled = !this._checkPermission('/cmsadmin/contentext/quote', 'POST')
      }
