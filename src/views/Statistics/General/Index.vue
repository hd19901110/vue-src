    ...
    <section class="today-box">
      ...
      <div class="today-content">
        ...
        <ul>
          ...
          <!-- <li><span>累计</span><span>{{(todayData.sum.depthNum||0)+'%' || todayData.sum.depthNumString}}</span></li> -->
        </ul>
        <ul>
          ...
          <!-- <li><span>累计</span><span>{{todayData.sum.time || todayData.sum.timeString}}</span></li> -->
        </ul>
      </div>
      <!-- <div v-show="tabShowName === 'contribution'">
        <P></P>
        <div class="contribution">
          <contribution class="contribution-left"> </contribution>
          <column class="contribution-right"> </column>
        </div>
      </div> -->
    </section>
      <search-header
...
export default {
  ...
  methods: {
    ...
    async handWebsiteListData () {
      let list = await this.$request.fetchstatisticsSitegeneralInfo()
      if (list.code === 200) {
