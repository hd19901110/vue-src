      ...
      return {
        ...
        buttons: [
          ...
          },
          {
            ...
            icon: 'fabu',
            disabled: !this._checkPermission('/cmsadmin/content/staticPage/channel', 'PUT') || !this.columnData.staticAble
          },
          {
            type: 'BatchCreate',
            text: '批量创建栏目',
            icon: 'piliangchuangjian',
            disabled: !this._checkPermission('/cmsadmin/channel/multiple', 'POST') || !this.columnData.createChildAble
          },
          {
            type: 'Merge',
            text: '合并栏目',
            icon: 'hebingfenping',
            disabled: !this._checkPermission('/cmsadmin/channel/merge', 'PUT') || !this.columnData.mergeAble
          },
          {
            type: 'Permission',
            text: '权限分配',
            ...
            disabled: !this._checkPermission('/cmsadmin/dataPerm/channel/user', 'GET') || !this._checkPermission('/cmsadmin/dataPerm/channel/org', 'GET') || !this.columnData.permAssignAble
          },
          {
            type: 'Delete',
            text: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/channel', 'DELETE') || !this.columnData.deleteAble
          }
        ]
      }
    }
