        ...
        buttons: [
          {
            ...
            text: '添加回复',
            icon: 'xinjian',
            disabled: !this._checkPermission('/cmsadmin/keyWord', 'POST')
          }
        ],
        showAlertIcon: false
      },
        ...
        handleColumn: [
          {
            ...
            name: '编辑',
            icon: 'bianji',
            disabled: !this._checkPermission('/cmsadmin/wechatreplycontent', 'PUT')
          },
          {
            type: 'Delete',
            name: '删除',
            icon: 'tangchuangguanbi',
            disabled: !this._checkPermission('/cmsadmin/wechatreplycontent', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: 'global.handle',
