        ...
        submitBtns: [
          {
            text: '保存',
            subType: 'submit',
            disabled: !this._checkPermission('/cmsadmin/wechatreplyclick', this.getType === 'add' ? 'POST' : 'PUT')
          },
          {
            text: '删除回复',
            subType: 'Delete',
            disabled: this.getReplyType === 2 || !this._checkPermission('/cmsadmin/wechatreplyclick', 'DELETE')
          }
        ],
        formItems: [
          {
