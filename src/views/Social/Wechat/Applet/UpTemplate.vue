<template>
  <section class="social-WeChat-applet-template">
    <el-button @click="redraw" class="top-btn" type="primary" size="small"
      :disabled="!_checkPermission('/cmsadmin/miniprogramCode/synch/template', 'GET')"
        ...
        handleColumn: [
          {
            ...
            disabled: !this._checkPermission('/cmsadmin/miniprogramCode/template/status', 'PUT')
          },
          {
            type: 'Delete',
            name: '删除',
            icon: 'delete',
            disabled: !this._checkPermission('/cmsadmin/miniprogramCode/template', 'DELETE')
          }
        ],
        handleColumnProp: {
          label: '操作',
