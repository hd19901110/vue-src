        ...
        submitBtns: [
          {
            ...
            disabled: !this._checkPermission('/cmsadmin/miniprogramversion/submit', 'POST')
          },
          {
            text: '提交审核',
            plain: true,
            ...
            disabled: !this._checkPermission('/cmsadmin/miniprogramversion/audit', 'POST')
          }
        ],
        ...
        submitBtns: [
          {
            ...
            disabled: !this._checkPermission('/cmsadmin/miniprogramversion/release', 'POST')
          },
          {
            text: '撤回审核',
            plain: true,
            ...
            disabled: !this._checkPermission('/cmsadmin/miniprogramversion/audit', 'DELETE')
          },
          {
            text: '重新审核',
            plain: true,
        ...
        submitBtns: [
          {
            ...
            disabled: !this._checkPermission('/cmsadmin/miniprogramversion/release/status', 'PUT')
          },
          {
            text: '设为可见',
            plain: true,
