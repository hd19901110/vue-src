        ...
        <div class="resource-wrap">
          ...
          <div class="resource-name">
            <el-link :underline='false' type='primary' class="jee-color"
              ...
              :disabled="!_checkPermission('/cmsadmin/wechatInfo', 'GET')"
        ...
        handleColumn: [
          {
            ...
            name: '取消授权',
            icon: 'quxiaoshouquan',
            disabled: !this._checkPermission('/cmsadmin/wechatInfo', 'DELETE')
          },
          {
          ...
          },
          {
            ...
            name: '设置管理员',
            icon: 'guanliyuan',
            disabled: !this._checkPermission('/cmsadmin/wechatInfo/coreUser', 'POST')
          }
        ],
        handleColumnProp: {
          label: 'global.handle',
