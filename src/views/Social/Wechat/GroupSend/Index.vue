                ...
                <div class="send-box__comment" v-if="getData[data.day]">
                  ...
                  <div class="send-box__btns" v-if="!dateFilter(data.day)">
                    <el-link
                      ...
                      :disabled="!_checkPermission('/cmsadmin/wechatsend', 'PUT')"
                    >
                    ...
                    <el-link
                      ...
                      :disabled="!_checkPermission('/cmsadmin/wechatsend', 'DELETE')"
                    >
  ...
  methods: {
    ...
    sendCalendar (data, item) {
      ...
      if (!status) {
        ...
        const addPerm = this._checkPermission('/cmsadmin/wechatsend', 'POST')
        const editPerm = this._checkPermission('/cmsadmin/wechatsend', 'PUT')
