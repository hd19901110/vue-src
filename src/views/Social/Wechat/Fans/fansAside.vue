    ...
    <div class="fans-aside-item is-active">
      ...
      <div class="fr">
        <el-link :underline='false' @click="syncTags"
          :disabled="!_checkPermission('/cmsadmin/wechattags/syncTags', 'GET')"
        >
          <jee-icon
        ...
        <el-link :underline='false' @click="addTags"
          :disabled="!_checkPermission('/cmsadmin/wechattags', 'POST')"
        >
          <jee-icon
            class="jee-hover-fill"
            iconClass="jia"
      ...
      <li
        ...
        <div class="fr fans-aside-edit">
          <el-link :underline='false' @click="editTags(item)"
            :disabled="!_checkPermission('/cmsadmin/wechattags', 'PUT')"
          >
            <jee-icon
              class="jee-hover-fill"
              iconClass="bianji"
          ...
          <el-link :underline='false' @click="deleteTags(item)"
            :disabled="!_checkPermission('/cmsadmin/wechattags', 'DELETE')"
          >
            <jee-icon
              class="jee-hover-fill"
