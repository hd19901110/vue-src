<template>
  <base-form
    class="s-image-radio-editor-containers s-draggable-editors"
    ref="baseForm"
            ...
            <template v-for="(option, index) in scope.form.options || []">
              <div class="option-item new-cont-option flex" :key="index" >
                ...
                <div class="option-radio-icon flex">
                  ...
                  <jee-icon iconClass="jianqu" class="jee-hover-fill option-radio-icons" @click="()=>handleDelOption(index)"></jee-icon>
...
<style lang="scss">
  .s-image-radio-editor-containers.s-draggable-editors{
